...
// Fetch request history joined with patient's DOB
$stmt = $conn->prepare("
    SELECT r.diagnosis, r.quantity, r.request_date, r.status, p.dob
    FROM blood_requests r
    JOIN patient_profile p ON r.username = p.username
    WHERE r.username = ?
...
<body>
  <div class="icon-container">
    <a href="patient_dashboard.php"><i class="fas fa-home"></i></a>
  </div>
  ...
  <div class="container">
    ...
    <?php if (count($requests) === 0): ?>
      <div class="message-box">
        ...
        <p>You haven't requested blood yet. Your requests will appear here once submitted.</p>
      </div>
    <?php else: ?>
