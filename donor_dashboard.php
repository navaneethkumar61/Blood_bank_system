...
if ($username) {
    $query = "SELECT status, COUNT(*) as count FROM donations WHERE username = ? GROUP BY status";
...
<body>
  ...
  <div class="menu" id="sidebar">
    <ul class="menu-content">
      ...
      <li><a href="donor_questionnaire.php"><i class="fa-solid fa-hand-holding-droplet"></i><span>Donation Form</span></a></li>
      <li><a href="donor_reports.php"><span class="material-symbols-outlined">report</span><span>Manage Report</span></a></li>
      <li><a href="donor_profile.php"><i class="fa-regular fa-address-card"></i><span>Update Profile</span></a></li>
